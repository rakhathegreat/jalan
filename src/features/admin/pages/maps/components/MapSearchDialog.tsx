...
export const MapSearchDialog = forwardRef<HTMLInputElement, MapSearchDialogProps>(
  (
    {
      open,
      onOpenChange,
            ...
            recentSearches.length === 0 ? (
              ...
              <>
                ...
                {recentSearches.map((item) => {
                  ...
                  const label = road ? getRoadPrimaryLabel(road) : item.label;
                  const secondary = road
                    ? getRoadSecondaryLabel(road)
                    : item.secondary;
                  ...
                  return (
                    <button
                      ...
                      onClick={() => road && onSelectRoad(road)}
                      disabled={!road}
                    >
